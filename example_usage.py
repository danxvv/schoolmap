...
class ScraperConfig:
    ...
    failed_codes_file: str = "failed_ct_codes_filtrados.txt"
...
async def read_ct_codes_from_file():
    ...
    try:
        ...
        with open("clave_ct_list_filtrados.txt", "r", encoding="utf-8") as f:
        ...
        error_msg = "File 'clave_ct_list_filtrados.txt' not found."
        print(f"❌ {error_msg}")
